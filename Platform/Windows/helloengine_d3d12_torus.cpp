...
struct SimpleConstants
{
	...
	XMFLOAT4 m_lightAttenuation;      //Ë¥¼õ
};
...
void InitConstants()
{
	...
	const XMVECTOR lightUpX       = XMVectorSet(1.0f, 0.0f, 0.0f, 0.0f);	
				...
				SimpleMesh* pDestMesh)
{
	...
	pDestMesh->m_indexCount             = triangles * 3;
	pDestMesh->m_indexType              = IndexSize::kIndexSize16;
...
void CreateDescriptorHeaps()
{
	...
	//Describe and create adepth stencil view(DSV) descriptor heap
	...
	//Describe and create resource view(SRV) and constant
	//buffer view (CBV)descriptor heap
	D3D12_DESCRIPTOR_HEAP_DESC cbvSrvHeapDesc = {};
	cbvSrvHeapDesc.NumDescriptors = nFrameCount + 1;   // FrameCOunt Cbvs + 1 Srv
